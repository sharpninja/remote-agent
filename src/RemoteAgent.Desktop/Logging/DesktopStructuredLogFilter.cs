...
public sealed class DesktopStructuredLogFilter
{
    ...
    public bool Matches(DesktopStructuredLogRecord row)
    {
        ...
        if (!string.IsNullOrWhiteSpace(ServerId) && !StringEquals(row.ServerId, ServerId)) return false;
